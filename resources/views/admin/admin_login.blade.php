...
.auth-page {
  .auth2-side-wrapper{
    width:100%;
    height:100%;
    background-image: url({{asset('backend/assets/upload/login.png')}});
    background-size: cover; /* اندازه تصویر برای پوشش کامل */
		...
		<div class="page-wrapper full-page">
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-4 pe-md-0">
                  <div class="auth2-side-wrapper">

                  </div>
                </div>
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo d-block mb-2">Easy<span>Leaning</span></a>
